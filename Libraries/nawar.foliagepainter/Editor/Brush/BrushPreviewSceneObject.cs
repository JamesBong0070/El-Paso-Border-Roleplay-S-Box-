...
public class BrushPreviewSceneObject : SceneCustomObject
{
	...
	{
		var material = Material.FromShader( "shaders/foliage/foliage_brush.shader" );
		...
		attributes.Set( "DecalRotation", new Vector4( Transform.Rotation.x, Transform.Rotation.y, Transform.Rotation.z, Transform.Rotation.w ) );

		Graphics.GrabDepthTexture( "DepthBuffer", attributes );

		//attributes.SetData( "Rotation", new Vector4( Transform.Rotation.x, Transform.Rotation.y, Transform.Rotation.z, Transform.Rotation.w ) );
